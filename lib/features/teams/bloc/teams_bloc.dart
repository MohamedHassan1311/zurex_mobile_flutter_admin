...
import '../repo/teams_repo.dart';

class TeamsBloc extends HydratedBloc<AppEvent, AppState> {
  final TeamsRepo repo;
  final InternetConnection internetConnection;

  TeamsBloc({required this.repo, required this.internetConnection})
      : super(Start()) {
  ...
  AppState? fromJson(Map<String, dynamic> json) {
    try {
      ...
      if (json['state'] == "Done") {
        return Done(
          list: List<TeamModel>.from(
              jsonDecode(json['list']).map((e) => TeamModel.fromJson(e))),
