          ...
          children: [
            ...
            Center(
              child: Wrap(
                ...
                spacing: 16.w,
                children: [
                  if (sl<SettingBloc>().model?.contactUs?.phone != null)
                    customContainerSvgIcon(
                        onTap: () => launchUrl(
                            Uri.parse(
                                "tel://${sl<SettingBloc>().model?.contactUs?.phone}"),
                        ...
                        radius: 100.w),
                  SizedBox(width: 16.w),
                  if (sl<SettingBloc>().model?.contactUs?.email != null)
                    customContainerSvgIcon(
                        onTap: () => launchUrl(
                            Uri.parse(
                                "mailto:${sl<SettingBloc>().model?.contactUs?.email ?? "zurex_admin@gmail.com"}"),
                            mode: LaunchMode.externalApplication),
